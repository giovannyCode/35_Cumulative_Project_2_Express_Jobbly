...
router.get("/", async function (req, res, next) {
  try {
    ...
    if (minEmployees) filter.minEmployees = minEmployees;
    if (maxEmployees) filter.maxEmployees = maxEmployees;
    // Pass the filter object to the Company.findAll function
